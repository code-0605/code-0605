...
- 🌱 Frontend : React, Next, Vue, Nuxt, Angular, Jquery, Bootstrap, TailwindCSS, Material UI, React Native
- 🔭 Backend : Ruby on Rails, Node.js, Laravel, Django
- 🧩 Database : MySQL, PostgreSQL, MongoDB, SQLite, Firebase
- 💬 Language : Javascript/Typescript, Ruby, Python, PHP
- 📫 Interesting : AI
